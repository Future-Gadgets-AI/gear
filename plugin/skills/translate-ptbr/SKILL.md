...
4. Translate only prose fields into PT-BR — `title`, each `tl_dr` item, and the body text. Copy every other field (`slug`, `date`, `tags`, `audience`, `canonical_url`) unchanged.

---
title: "The factory that built its own tools"
slug: factory-built-its-own-tools
date: 2026-07-05
status: approved
tags: [dark-factory, bootstrapping, dogfooding]
audience: engineers and engineering leaders evaluating agentic development workflows
canonical_url: https://future-gadgets-ai.github.io/gear/posts/factory-built-its-own-tools/
tl_dr:
...
> **pull-quote:** A fixture proves the tool can go through the motions; a production debut proves it survives contact with the real board.
...
> **pull-quote:** On its first live run, the recommender's top candidate would have been itself — and the verify gate is why it wasn't.

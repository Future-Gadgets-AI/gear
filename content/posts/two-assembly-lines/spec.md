---
title: "The night the factory ran two assembly lines"
slug: two-assembly-lines
date: 2026-07-05
status: approved
tags: [dark-factory, delegation, merge-gate, governance]
...
tl_dr:
  - An AI session held delegated merge authority for one evening — seven pull requests merged across two repos in about two hours, each with a logged rationale.
...
> **pull-quote:** The covenant is "humans author and approve; the line runs autonomously." Delegation transfers the accountability, not the impulsiveness.
...
> **pull-quote:** Trust the pattern, verify at the gate — self-correcting workers reduce defects, not the need for review.
...
> **pull-quote:** The rollback was written before the switch was flipped — before-values, verbatim, in a committed runbook.
...
> **pull-quote:** If your retro can't survive your own review gate, it isn't a retro — it's marketing.

---
title: "One keystroke to merged pull request: anatomy of a lights-out run"
slug: one-keystroke-anatomy
date: 2026-07-05
status: approved
...
> **pull-quote:** The whole autonomous run fits inside a public, verifiable 100-minute window — the human appears twice: one keystroke in, one merge out.
...
> **pull-quote:** The code did what the spec said — and executing it against live state is what revealed the spec was wrong.
